...
echo "RUNNING TEST"
echo "        TEST part 1"
mpirun -n 15 --oversubscribe ../../../dagster -m 0 -g 1 ./dag.txt ./cnf.txt -o output1.sols
echo "        TEST part 2"
mpirun -n 15 --oversubscribe ../../../dagster -m 1 -k 1 -g 1 ./dag.txt ./cnf.txt -o output2.sols
echo "        TEST part 3"
mpirun -n 15 --oversubscribe ../../../dagster -m 2 -k 1 -g 1 ./dag.txt ./cnf.txt -o output3.sols
echo "        TEST part 4"
