...
menu_top = menu(u'Main Menu', [
	...
	sub_menu(u'gNovelty+ Configuration', [
		...
		urwid.AttrMap(E(urwid.IntEdit, [u'gNovelty+ suggestion size: ',30], 's', {"help":"The size of the buffer that the SLS processes will report to the CDCL process, the greater the size of the buffer, the "}), None, focus_map='reversed'), #TODO
