...
mpirun -n 2 /bin/bash -c 'valgrind --tool=massif --massif-out-file=massif.${OMPI_COMM_WORLD_RANK} timeout 60m ../dagster ../unit_testing/good/d1.txt ../unit_testing/good/c1.txt'
