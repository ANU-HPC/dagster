...
mpirun -n 6 valgrind --suppressions=/usr/share/openmpi/openmpi-valgrind.supp --leak-check=yes ../dagster -m 1 -k 2 -a ghosts ../unit_testing/good/d1.txt ../unit_testing/good/c1.txt
