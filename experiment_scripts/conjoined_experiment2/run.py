...
for cc in range(5,100,20):
	...
	for processors in [3,4,5,6]:
		t1 = timeit("mpirun -n {} ../../dagster/dagster -m 0 -g 2 -e 3 ./dag5.txt ./cnf5.txt".format(processors))
		t3 = timeit("mpirun -n {} ../../dagster/dagster -m 1 -k 1 -g 2 -e 3 ./dag5.txt ./cnf5.txt".format(processors))
		with open("timing_data.txt","a") as f:
			f.write("{},{},{},{},{}\n".format(cc,processors,t1,t2,t3))
